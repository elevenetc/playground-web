...
class SampleCompositor extends Compositor {
	constructor() {
		...
		// super.addComposite(new LargeTank(groundModel, 0, 2, 2, 0, 'a'));
		super.addComposite(new Tank(groundModel, 0, 3, 2, 0, 'a'));
		// super.addComposite(new Tank(groundModel, 0, 3, 3, 0, 'b'));
